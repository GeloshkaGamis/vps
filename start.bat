...
net config server /srvcomment:"Windows Server 2019 By GetDrive" > out.txt 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer" /V EnableAutoTray /T REG_DWORD /D 0 /F > out.txt 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Run" /f /v Wallpaper /t REG_SZ /d D:\a\wallpaper.bat
net user RealVovanGames Vovka102437 /add >nul
net localgroup administrators RealVovanGames /add >nul
net user RealVovanGames /active:yes >nul
net user installer /delete
diskperf -Y >nul
sc config Audiosrv start= auto >nul
sc start audiosrv >nul
ICACLS C:\Windows\Temp /grant RealVovanGames:F >nul
ICACLS C:\Windows\installer /grant RealVovanGames:F >nul
...
echo Username: RealVovanGames
echo Password: Vovka102437
